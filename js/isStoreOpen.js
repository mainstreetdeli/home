...
if (day >= 0 && day <= 4) {
    if (hour >= 5 && hour < 21) {
        ...
        // document.write(
        // "<div><h3 class='open-sign' style='display: inline-block;'>OPEN</h3></div><br>"
        // );
    }
        ...
        // document.write(
        // "<div><h3 class='closing-soon-sign' style='display: inline-block;'>CLOSING SOON</h3></div><br>"
        // );
    }
    else {
        document.write(
        ...
        // document.write(
        // "<div><h3 class='closed-sign' style='display: inline-block;'>CLOSED</h3></div><br>"
        // );
    }
}
else if (day > 4) {
